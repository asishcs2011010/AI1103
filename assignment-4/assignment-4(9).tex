...
%
\begin{lstlisting}
https://github.com/asishcs2011010/demo/blob/main/assignment-4/assignment-4(9).tex 
\end{lstlisting}
\section*{question no}
...
\begin{align}
 ...
 \end{align}
 \begin{align}
  & y<0 \rightarrow \mbox F_Y\brak{ y} = 0\\
  & 0\le y<1 \rightarrow \mbox F_Y\brak{ y} &&= \mbox F_X\brak{\sqrt y} - \mbox F_X\brak{-\sqrt y}\\
  & & & = \left(  \frac{\sqrt{y}+1}{3} \right) - \left( \frac{-\sqrt{y}+1}{3} \right) \\ 
  & & & = \left( \frac{2\sqrt{y}}{3} \right)
  \end{align}
  \begin{align}
  & 1\le y<4 \rightarrow \mbox F_Y\brak{ y} = \left(  \frac{\sqrt{y}+1}{3} \right) - 0 = \left(  \frac{\sqrt{y}+1}{3} \right)
 \end{align}
 \begin{align}
 & y \ge 4 \rightarrow  \mbox F_Y\brak{ y} = 1-0 = 1 
 \end{align}
The cdf of Y is 
\begin{center}
  $\mbox F_Y\brak{y}$ =  
