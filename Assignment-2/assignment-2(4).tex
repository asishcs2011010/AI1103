...
%
\begin{lstlisting}
https://github.com/asishcs2011010/demo/blob/main/Assignment-2/assignment-2(4).tex
\end{lstlisting}
\section*{question no}
Gate-EC Q-38
\section*{Question}
...
\begin{align}
  ...
  \begin{align}
  \mbox Pr(Z = z) = \sum_{k}\mbox Pr(X = K)\times \mbox Pr(Y = z-k) 
  \end{align}
  equation (0.0.7) can be written as following using convolution operation
    \begin{align}
...
\end{align}
\begin{align}
  \mbox Pr(Z<1) = \mbox P(Z=0)  
  \end{align}
  From equation (0.0.12), we get
\begin{align}
