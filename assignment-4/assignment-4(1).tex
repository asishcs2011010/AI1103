...
\begin{lstlisting}
https://github.com/asishcs2011010/demo/blob/main/assignment-4/assignment-4(1).py
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/asishcs2011010/demo/blob/main/assignment-4/assignment-4.tex 
\end{lstlisting}
\section*{question no}
...
\end{align}
The cdf of Y = $X^2$ is given by G\brak{y}\\
\begin{align}
G\brak{y} = F_X\brak{y}= \mbox Pr(X^2 \le y)=\mbox Pr(X \le\sqrt{y})= F_X\brak{\sqrt{y}}\\
